...
FRACTAL_DESCRIPTIONS: dict[str, str] = {
    ...
    "formule_cosinus_c": "Formula preset: z_{n+1} = cos(z_n) + c.",
    "formule_biomorphe": "Formula preset: z_{n+1} = z_n^2 + z_n/c.",
    "formule_tricorne": "Formula preset: z_{n+1} = conjugate(z_n)^2 + c.",
    "formule_perturbee_canonique": "Formula preset: z_{n+1} = z_n^2 + c + 0.25 sin(z_n).",
    "formule_rationnelle_canonique": "Formula preset: z_{n+1} = z_n^2 + c + 0.2/(z_n^2 + 0.4).",
    "formule_exponentielle_canonique": "Formula preset: z_{n+1} = exp(z_n) + c - 1.",
    "formule_tangente_canonique": "Formula preset: z_{n+1} = tan(z_n) + 0.6c.",
    "formule_norme_canonique": "Formula preset: z_{n+1} = z_n^2 + c - 0.08|z_n|^2.",
