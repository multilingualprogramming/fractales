...
REQUIRED_EXPORTS = {
    ...
    "attracteur_de_clifford_etape",
    "attracteur_de_peter_de_jong",
    "attracteur_de_peter_de_jong_etape",
    "attracteur_ikeda",
    "attracteur_ikeda_etape",
    "attracteur_de_henon",
    "attracteur_de_henon_etape",
    "lorenz_attractor",
    "lorenz_attractor_etape",
    "projeter_lorenz_x",
    "projeter_lorenz_y",
    "rossler_attractor",
    "rossler_attractor_etape",
    "projeter_rossler_x",
    "projeter_rossler_y",
    "aizawa_attractor",
    "aizawa_attractor_etape",
    "projeter_aizawa_x",
    "projeter_aizawa_y",
    "sprott_attractor",
    "sprott_attractor_etape",
    "projeter_sprott_x",
    "projeter_sprott_y",
    "feigenbaum_tree",
    "barnsley",
...
def check_process_pipeline() -> None:
    """Verify the semantic-core-v1 process pipeline (multilingual 0.8.2).
