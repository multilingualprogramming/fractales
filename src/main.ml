...
importer fractales_lisse
importer fractales_orbitrap
#
...
soit MODES_EVASION = ["mandelbrot", "julia", "burning_ship", "tricorn", "multibrot", "celtic", "buffalo", "perpendicular_burning_ship", "heart", "perpendicular_mandelbrot", "perpendicular_celtic", "duck", "buddhabrot", "burning_julia", "biomorphe"]
soit MODES_DYNAMIQUE = ["newton", "phoenix", "lyapunov", "lyapunov_multisequence", "bassin_newton_generalise", "orbitale_de_nova", "collatz_complexe", "attracteur_de_clifford", "attracteur_de_peter_de_jong", "attracteur_ikeda", "attracteur_de_henon", "lorenz_attractor", "rossler_attractor", "aizawa_attractor", "sprott_attractor", "feigenbaum_tree", "duffing_attractor"]
...
soit MODES_LISSE = ["mandelbrot_lisse", "julia_lisse", "burning_ship_lisse", "tricorn_lisse"]
soit MODES_ORBITRAP = ["mandelbrot_piege_cercle", "mandelbrot_piege_croix", "mandelbrot_piege_ligne", "julia_piege_cercle"]
soit MODES_CLASSES_COMPAT = ["mandelbrot_classe"]
affirmer longueur(MODES_EVASION) == 15
affirmer longueur(MODES_DYNAMIQUE) == 17
...
affirmer longueur(MODES_LISSE) == 4
affirmer longueur(MODES_ORBITRAP) == 4
